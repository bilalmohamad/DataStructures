...
/**
 * Tests the AdjacencyMapGraph class
 *
...
public class AdjacencyMapGraphTest {
	...
	/**
	 * Tests the AdjacencyMapGraph constructor with nothing entered in its parameter
	 */
	@Test
	public void testEmptyConstructor() {
		
		//Undirected graph
		AbstractGraph<String, Integer> graph = new AdjacencyMapGraph<String, Integer>();
		assertEquals(false, graph.isDirected());			
	}
	
	
	/**
	 * Tests the AdjacencyMapGraph class's methods with true entered in the constructor parameter
	 */
	@Test
	public void testAdjacencyMapGraph() {
		
		//Directed graph
		AbstractGraph<String, Integer> graph = new AdjacencyMapGraph<String, Integer>(true);
		...
		*/
		...
		assertNotNull(graph.incomingEdges(day1));
		assertNotNull(graph.outgoingEdges(day5));
	}
}
