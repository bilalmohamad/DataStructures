...
public class AdjacencyListGraphTest {
	...
	/**
	 * Tests the AdjacencyListGraph constructor with nothing entered in its parameter
	 */
	@Test
	public void testEmptyConstructor() {
		
		//Undirected graph
		AbstractGraph<String, Integer> graph = new AdjacencyListGraph<String, Integer>();
		assertEquals(false, graph.isDirected());			
	}
	
	
	/**
	 * Tests the AdjacencyListGraph class's methods with true entered in the constructor parameter
	 */
	@Test
