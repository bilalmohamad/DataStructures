...
public class AdjacencyMatrixGraphTest {
	...
	/**
	 * Tests the AdjacencyMatrixGraph constructor with nothing entered in its parameter
	 */
	@Test
	public void testEmptyConstructor() {
		
		//Undirected graph
		AbstractGraph<String, Integer> graph = new AdjacencyMatrixGraph<String, Integer>();
		assertEquals(false, graph.isDirected());			
	}
	
	
	/**
	 * Tests the AdjacencyMatrixGraph class's methods with true entered in the constructor parameter
	 */
	@Test
	public void testAdjacencyMatrixGraph() {
		
		//Directed graph
		AbstractGraph<String, Integer> graph = new AdjacencyMatrixGraph<String, Integer>(true);
