...
public class BinarySearchTreeMapTest {
	...
	/**
	 * Tests the methods of the BinarySearchTreeMap class.
	 * Tests the methods of the BinarySearchTreeMap super class
	 */
	@Test
	public void testBinarySearchTreeMap() {
		
		BinarySearchTreeMap<String, String> tree = new BinarySearchTreeMap<String, String>();
	...
	public void testRemove() {
		...
		BinarySearchTreeMap<String, String> tree = new BinarySearchTreeMap<String, String>(null);
		assertEquals(0, tree.size());
		assertEquals(true, tree.isEmpty());
		...
		assertEquals(PHONE_1, tree.remove(NAME_1));
		assertEquals(PHONE_2, tree.remove(NAME_2));
		assertEquals(PHONE_3, tree.remove(NAME_3));
		assertEquals(PHONE_4, tree.remove(NAME_4));
		assertEquals(PHONE_5, tree.remove(NAME_5));
		assertEquals(PHONE_6, tree.remove(NAME_6));
		assertEquals(PHONE_7, tree.remove(NAME_7));
	}
}
