...
public class SplayTreeMapTest {
	...
	/**
	 * Tests the methods of the SplayTreeMap class.
	 * Tests the methods of the BinarySearchTreeMap super class
	 */
	@Test
	public void testSplayTreeMap() {
		
		BinarySearchTreeMap<String, String> tree = new SplayTreeMap<String, String>();
	...
	public void testRemove() {
		...
		BinarySearchTreeMap<String, String> tree = new SplayTreeMap<String, String>(null);
		assertEquals(0, tree.size());
		assertEquals(true, tree.isEmpty());
