...
public class AVLTreeMapTest {
	...
	/**
	 * Tests the methods of the AVLTreeMap class.
	 * Tests the methods of the BinarySearchTreeMap super class
	 */
	@Test
	public void testAVLTreeMap() {
		
		BinarySearchTreeMap<String, String> tree = new AVLTreeMap<String, String>();
	...
	public void testRemove() {
		...
		BinarySearchTreeMap<String, String> tree = new AVLTreeMap<String, String>(null);
		assertEquals(0, tree.size());
		assertEquals(true, tree.isEmpty());
